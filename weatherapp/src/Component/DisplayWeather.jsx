    ...
    const getWeather = async () => {
        try {
            ...
            const responseForecast = fetch(
                `https://api.openweathermap.org/data/2.5/forecast/daily?${cityValue ? 'q=' + cityValue : 'lat=' + latitude + '&lon=' + longitude}&appid=${key}&units=metric&lang=KR`,
            );
            ...
            setForecastValue(resultForecast);
